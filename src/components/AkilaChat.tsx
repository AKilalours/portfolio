...
const KB = {
  ...
  experience: `Akila has three roles:\n\n1️⃣ Machine Learning Engineering Intern — Phamily / Jaan Health (May 2026 – Present, New York, On-site)\n• Built the production BigQuery data pipeline (Python/pandas, Gemini AI.GENERATE_TABLE, Presidio de-identification) unifying 14+ event sources into PHI-safe longitudinal patient timelines\n• Trained and deployed a BioBERT ER-visit risk classifier across 1/7/14/30-day horizons, reaching 71% precision and recall at 30 days\n• Architected a two-pass LLM extraction + QA pipeline yielding 500K+ discrete care needs, with blind clinician validation\n• Fixed a batched-inference hang (bounded retries + hard timeout + checkpointing) and drove a 33% clinician-model grading disagreement rate to 0%\n\n2️⃣ Volunteer Full-Stack Developer — People In Need Inc. (Dec 2025 – Jan 2026, Remote)\n• Shipped a production-grade public website from scratch (peopleinneed.org)\n• Built a unified backend powering 4 nonprofit workflows\n• Automated the monthly newsletter pipeline end-to-end\n\n3️⃣ Software Development Intern — Archimedis Digital (Feb–Apr 2023, Chennai, On-site)\n• Owned end-to-end documentation for software modules\n• Drove defect resolution via structured testing and root-cause analysis`,
